...
# third-party imports
from paper_version.ext.lab2im import utils, edit_volumes
...
class BrainGenerator:
    ...
    def __init__(self,
        ...
        :param use_generation_classes: (optional) if a self-defined generation_classes is provided, the chance that it
        will be used for brain generation.
    ...
    def _build_model_inputs_generator(self, mix_prior_and_random):
        ...
        # print("_build_model_inputs_generator")
        model_inputs_generator = build_model_inputs(path_label_maps=self.labels_paths,
                                                    ...
                                                    use_generation_classes=self.use_generation_classes,
                                                    apply_linear_trans=self.apply_linear_trans,
