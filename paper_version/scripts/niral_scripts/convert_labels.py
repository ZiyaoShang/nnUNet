...
path_gt = utils.list_images_in_folder(r"/home/ziyaos/Desktop/look/BEE_plus/all_choices/GTs")
...
for image in range(len(path_gt)):
    ...
    padded = edit_volumes.crop_volume(gt, cropping_shape=(154, 174, 148))
    ...
    save = r"/home/ziyaos/Desktop/look/BEE_plus/all_choices/GTs/" + "cp_" + path_gt[image].split('/')[-1]
