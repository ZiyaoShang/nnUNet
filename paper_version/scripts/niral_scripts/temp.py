...
import sys
import numpy as np
masks = utils.list_images_in_folder(r"/home/ziyaos/Desktop/look/BEE_plus/masks")
T1s = utils.list_images_in_folder(r"/home/ziyaos/Desktop/look/BEE_plus/T1s")
T2s = utils.list_images_in_folder(r"/home/ziyaos/Desktop/look/BEE_plus/T2s")
...
for i in range(len(masks)):
    ...
    save1 = r"/home/ziyaos/Desktop/look/BEE_plus/T1s/" + T1s[i].split('/')[-1]
    save2 = r"/home/ziyaos/Desktop/look/BEE_plus/T2s/" + T2s[i].split('/')[-1]
